 ...
 */
public class ShyGuyTNGRunning extends ModelBase {
    ...
    public ShyGuyTNGRunning() {
        ...
        this.setRotateAngle(RThumb, -0.9560913642424937F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LArm, -1.5481070465189704F, 0.091106186954104F, 0.0F);
        ...
        this.setRotateAngle(Head, -6.542017635250344F, 0.017453292519943295F, 0.0F);
        ...
        this.setRotateAngle(RArmLow, 0.0F, -1.5481070465189704F, 0.0F);
        ...
        this.setRotateAngle(LFingerSet2a, 0.5009094953223726F, 0.36425021489121656F, 0.27314402793711257F);
        ...
        this.setRotateAngle(RArm, -1.5481070465189704F, -0.091106186954104F, 0.0F);
        ...
        this.setRotateAngle(RArmLow_1, 0.0F, 1.5481070465189704F, 0.0F);
        ...
        this.setRotateAngle(LThumb, -0.9560913642424937F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(LHand_1, 0.0F, 0.0F, -1.0016444577195458F);
        this.RJaw = new ModelRenderer(this, 14, 14);
        this.RJaw.setRotationPoint(0.5F, -1.4F, -1.4F);
        this.RJaw.addBox(-0.5F, 0.0F, -2.0F, 3, 5, 4, 0.0F);
        this.setRotateAngle(RJaw, 0.0F, -0.12217304763960307F, -0.7869689597242432F);
        ...
        this.setRotateAngle(RFingerSet2a, 0.5009094953223726F, -0.40980330836826856F, -0.18203784098300857F);
        ...
        this.LHand.setRotationPoint(0.3F, 10.5F, 0.0F);
        this.LHand.addBox(-2.0F, -1.5F, -1.5F, 2, 4, 3, 0.0F);
        this.setRotateAngle(LHand, 0.0F, 0.0F, 1.0016444577195458F);
        this.LJaw = new ModelRenderer(this, 0, 14);
        this.LJaw.setRotationPoint(-0.5F, -1.4F, -1.4F);
        this.LJaw.addBox(-2.5F, 0.0F, -2.0F, 3, 5, 4, 0.0F);
        this.setRotateAngle(LJaw, 0.0F, 0.0F, 0.5426228644450372F);
