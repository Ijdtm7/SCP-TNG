 ...
 */
public class ShyGuyTNGSitting extends ModelBase {
    ...
    public ShyGuyTNGSitting() {
        ...
        this.setRotateAngle(LFeet, 0.5462880558742251F, 0.0F, 0.0F);
        this.LLegJoint = new ModelRenderer(this, 0, 0);
        this.LLegJoint.setRotationPoint(0.0F, 16.899999999999974F, 2.0000000000000004F);
        ...
        this.setRotateAngle(RLeg, -2.504198410761464F, -0.045553093477052F, 0.0F);
        ...
        this.setRotateAngle(RFeet, 0.5462880558742251F, 0.0F, 0.0F);
        this.BodyMiddle = new ModelRenderer(this, 32, 10);
        this.BodyMiddle.setRotationPoint(1.5F, -7.4F, 0.3F);
        ...
        this.setRotateAngle(RArmLow_1, -0.7285004297824331F, 0.091106186954104F, 2.0943951023931953F);
        this.RLegJoint = new ModelRenderer(this, 0, 0);
        this.RLegJoint.setRotationPoint(0.0F, 16.899999999999974F, 2.0000000000000004F);
        ...
        this.setRotateAngle(RLegLow, 0.8651597102135892F, 0.0F, 0.0F);
        this.BodyLow = new ModelRenderer(this, 32, 21);
        this.BodyLow.setRotationPoint(0.0F, 16.39999999999997F, 2.7F);
        ...
        this.RSholder.setRotationPoint(3.2F, 8.09999999999999F, -0.8F);
        ...
        this.setRotateAngle(LHand_1, -0.27314402793711257F, -0.5009094953223726F, 0.4553564018453205F);
        this.LLeg = new ModelRenderer(this, 0, 35);
        this.LLeg.setRotationPoint(-2.0F, 0.6F, 1.7F);
        this.LLeg.addBox(-1.0F, 0.0F, -1.0F, 2, 9, 2, 0.0F);
        this.setRotateAngle(LLeg, -2.504198410761464F, 0.045553093477052F, 0.0F);
        this.LSholder = new ModelRenderer(this, 10, 23);
        this.LSholder.setRotationPoint(-3.2F, 8.09999999999999F, -0.8F);
        ...
        this.setRotateAngle(LArm, -1.0016444577195458F, -0.18203784098300857F, 0.0F);
        ...
        this.Head.setRotationPoint(0.0F, 3.799999999999982F, -3.7F);
        ...
        this.setRotateAngle(LHand, 0.136659280431156F, 0.31869712141416456F, -0.8651597102135892F);
        ...
        this.setRotateAngle(RArm, -1.0016444577195458F, 0.18203784098300857F, 0.0F);
        this.Neck = new ModelRenderer(this, 0, 23);
        this.Neck.setRotationPoint(0.0F, 7.29999999999999F, -0.7F);
        ...
        this.setRotateAngle(LLegLow, 0.8651597102135892F, 0.0F, 0.0F);
        ...
        this.setRotateAngle(RArmLow, -0.7285004297824331F, 0.091106186954104F, -2.0943951023931953F);
